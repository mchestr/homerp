          ...
          {entries.map(([key, value], index) => {
            ...
            return (
              <div key={index} className="space-y-1">
                <div
                  className={cn(
                    "pointer-events-none flex gap-2 rounded-lg transition-all",
                ...
                >
                  <div
                    className="text-muted-foreground hover:text-foreground pointer-events-auto flex h-10 w-8 shrink-0 cursor-grab items-center justify-center active:cursor-grabbing"
                  ...
                  <input
                    ...
                    className={cn(
                      "bg-background focus:border-primary focus:ring-primary/20 pointer-events-auto h-10 flex-1 rounded-lg border px-3 text-sm transition-colors focus:ring-2 focus:outline-hidden",
                      hasDuplicate &&
                  ...
                  <input
                    ...
                    className="bg-background focus:border-primary focus:ring-primary/20 pointer-events-auto h-10 flex-1 rounded-lg border px-3 text-sm transition-colors focus:ring-2 focus:outline-hidden"
                  ...
                  <Button
                    ...
                    className="text-muted-foreground hover:text-destructive pointer-events-auto h-10 w-10 shrink-0"
